...
I am a passionate Data Science learner at Diamond, focused on building strong skills in Artificial Intelligence, Machine Learning, and Generative AI. I have hands-on experience with Natural Language Processing (NLP) and Large Language Models (LLMs), and I actively explore frameworks such as LangChain to develop LLM-based applications. I am also learning Agentic AI tools to understand how intelligent agents can automate workflows and solve complex tasks.Alongside AI technologies, I have a solid foundation in SQL Server, which I use for data querying, cleaning, and analysis to support data-driven decision-making. I continue to strengthen my knowledge of data preprocessing, model evaluation, and core statistical concepts.My goal is to grow into a skilled Data Scientist / AI Engineer who can contribute to innovative, real-world projects by combining data science with cutting-edge AI tools. I am open to opportunities for internships, entry-level roles, and collaborative projects where I can apply my skills and continue learning.
